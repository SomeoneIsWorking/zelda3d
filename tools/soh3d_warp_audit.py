#!/usr/bin/env python3
"""soh3d_warp_audit.py — quantify the terrain warp's BENEFIT vs HARM for a scene room.

The terrain warp (soh3d_model.cpp warpRoomMesh / soh3d_warp.py) shifts every render-mesh
...
Usage:
  SOH3D_3DS_ROM=<rom> python3 tools/soh3d_warp_audit.py /scene/spot04_0_info.zsi scratch/floor/n64_kokiri.csv
"""
...
STEP = float(os.environ.get("SOH3D_WARP_STEP", "100"))
REJECT = float(os.environ.get("SOH3D_WARP_REJECT", "120"))
