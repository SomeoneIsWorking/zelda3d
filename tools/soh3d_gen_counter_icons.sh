...
# persistent RGBA32). Backlog #31 (UI textures); mirror of tools/soh3d_gen_button_tex.sh /
# soh3d_gen_hud_tex.sh / soh3d_gen_digit_tex.sh (the reusable SVG->texture pipeline).
#   tools/soh3d_gen_counter_icons.sh
...
HDR="$REPO/Shipwright/soh/src/soh3d/counter_icon_png.h"
...
<!-- GENERATED crisp rupee counter icon. Grayscale = facet bevel intensity; the rupee colour is
     applied by the HUD combine via PRIM. See tools/soh3d_gen_counter_icons.sh. -->
...
{
  echo "// GENERATED by tools/soh3d_gen_counter_icons.sh — do not edit."
