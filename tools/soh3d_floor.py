#!/usr/bin/env python3
"""soh3d_floor.py — query the OoT3D room mesh floor height at world XZ point(s).

Loads a scene/room CMB (the SAME mesh SoH3D renders), then for each (x,z) finds
...
Usage:
  SOH3D_3DS_ROM=<rom> tools/soh3d_floor.py /scene/spot01_0_info.zsi x z [x z ...]
  # or pairs "x,z[,n64floor]" to also print the delta vs a known N64 floor:
  SOH3D_3DS_ROM=<rom> tools/soh3d_floor.py /scene/spot01_0_info.zsi -2451,1062,138
"""
import os, sys
