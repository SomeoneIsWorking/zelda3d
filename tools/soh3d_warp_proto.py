#!/usr/bin/env python3
"""soh3d_warp_proto.py — prototype + measure improved terrain-warp variants offline.

Validates warp algorithm changes on real scene data BEFORE porting to C++
(soh3d_model.cpp warpRoomMesh). Reports, for a scene + REPL floorgrid CSV:
...
Usage: SOH3D_3DS_ROM=<rom> python3 tools/soh3d_warp_proto.py <scene.zsi> <n64.csv>
"""
