#!/usr/bin/env python3
"""soh3d_warp.py — reference implementation + offline verification of the terrain warp.
...
Usage:
  SOH3D_3DS_ROM=<rom> tools/soh3d_warp.py /scene/spot01_0_info.zsi scratch/floor/n64_spot01.csv
"""
import os, sys, math
...
REJECT = float(os.environ.get("SOH3D_WARP_REJECT", "120"))  # |D| above this = structure, not ground
