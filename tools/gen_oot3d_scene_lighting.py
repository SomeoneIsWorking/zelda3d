...
def main():
    ...
    with open(OUT, "w") as o:
        ...
        o.write("// Native-3DS ZSI cmd 0x0F: 16-byte header + 28-byte records (fog f32 x2,\n")
        o.write("// u16 ?, amb, u8[3] ?, l0col, l0dir, l1col, l1dir). Row i == runtime slot i\n")
        o.write("// (NO bias): the N64 z_kankyo schedule index selects the matching OoT3D row\n")
        o.write("// directly. See the generator docstring for the byte-level derivation.\n")
