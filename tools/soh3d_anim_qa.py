#!/usr/bin/env python3
"""SoH3D player-animation QA sweep.
...
Requires the game already running (tools/soh3d_game.sh start 238 0x6000) with link 1 / linksrc 3ds.

Usage:  tools/soh3d_anim_qa.py            # full sweep
        tools/soh3d_anim_qa.py <name>...  # only the named transitions
"""
import sys, os, time, statistics
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
import soh3d_repl as r
...
def main():
    ...
    only = set(sys.argv[1:])
    print("=== SoH3D player-anim QA sweep (per-DRAWN-frame max bone-rotation jump, deg) ===")
