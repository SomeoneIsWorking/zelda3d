...
The N64-animation port (SoH3D_UpdateAnimN64) drives the OoT3D geldwoman skeleton from
...
Usage:
  python3 tools/soh3d_anim_derive.py scratch/bin/ge1_joints.csv [csab_frame]
  (SOH3D_3DS_ROM must be set; reads /actor/zelda_ge1.zar : Model/geldwoman.cmb + ge1_s_wait)
"""
