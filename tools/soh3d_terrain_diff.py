#!/usr/bin/env python3
"""soh3d_terrain_diff.py — characterize the OoT3D-render vs N64-collision floor mismatch.
...
each sampled (x,z) we compute the OoT3D room-mesh floor (same raycast as soh3d_floor.py,
the surface SoH3D *draws*) and report delta = OoT3D - N64.
...
Usage:
  SOH3D_3DS_ROM=<rom> tools/soh3d_terrain_diff.py /scene/spot01_0_info.zsi scratch/floor/n64_spot01.csv
"""
import os, sys, math
