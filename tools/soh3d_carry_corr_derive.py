...
Why this exists (the idle-only fit is insufficient):
  The shoulders (b14 left, b18 right) are mode-2 (C·R) in soh3d_link_bonecorr.inc, hand-woven
...
Constraints fitted per bone (Procrustes least-squares, tools/soh3d_link_retarget_derive style):
...
Usage:
  . ./.env && python3 tools/soh3d_carry_corr_derive.py
...
BONECORR_INC = "Shipwright/soh/src/soh3d/soh3d_link_bonecorr.inc"

# OoT3D bone -> N64 player limb (mirror of BONEMAP in soh3d_link_retarget_derive.py). dump limb = m+1.
