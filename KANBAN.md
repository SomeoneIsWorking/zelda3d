...
> Columns: todo · in-progress · in-review · needs-confirmation · reopened · blocked · done(=closed).  Updated 2026-06-23 17:12.

**Counts:** todo:3 | in-progress:2 | in-review:0 | needs-confirmation:34 | reopened:1 | blocked:1 | done:45
...
## ✅ Done (recently closed)  (showing 30 of 45)
- [#101](../../issues/101) En_Ei (Stinger jellyfish) plays damage anim instead of swimming (gStingerHitAnim → ei_swim)
- [#100](../../issues/100) Talon (En_Ta) sit-sleep animation wrong (taron_sleep_wait 32f instead of ta_inemuri 100f)
