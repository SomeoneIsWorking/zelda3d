...
> Columns: todo · in-progress · in-review · needs-confirmation · reopened · blocked · done(=closed).  Updated 2026-06-19 19:26.

**Counts:** todo:10 | in-progress:1 | in-review:0 | needs-confirmation:2 | reopened:6 | blocked:1 | done:0

## 📋 To Do  (10)
- [#6](../../issues/6) Held cucco renders at pickup spot, not in Link's hands _(render,cucco)_
...
- [#19](../../issues/19) Cucco Lady T-pose fixed (verify in playtest) _(anim,scene)_

## ♻️ Reopened (was done, found broken)  (6)
...
## ✅ Done (recently closed)  (showing 0 of 0)
