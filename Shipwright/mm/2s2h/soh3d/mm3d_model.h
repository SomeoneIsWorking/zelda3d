...
// soh3d_model.cpp). Owns the MM3D asset ROM (CtrRom over ZELDA3D_MM_3DS_ROM), the
// actor/object -> CMB tables, and the renderer model provider registered through the
// SHARED libultraship seam SoH3D_GL_SetModelProvider. Geometry conversion reuses the
// shared cmb3d converter (SoH3D::MakeGlGroup / AppendCmbTextures) — no duplication.
//
