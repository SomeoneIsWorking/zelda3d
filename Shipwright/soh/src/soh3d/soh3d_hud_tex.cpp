// SoH3D HUD texture generation — crisp runtime-built HUD textures (button glyphs, hearts, counter
// icons, digits) packed from embedded PNGs. Split out of soh3d_model.cpp (pure move, no behavior
// change) so the model loader stays focused. Declarations live in soh3d.h; the renderer/HUD path
...
#include <cmath>
#include <stb_image.h>
#include "asset/texpack.h"     // SoH3D::TexPackLookup (HD texture-pack atlas source)
#include "xbox_glyphs_png.h"   // assets/soh3d/xbox_{a,b,x,y}.svg (HUD button glyphs, #32)
#include "heart_tex_png.h"     // crisp HUD heart textures (#31)
#include "digit_tex_png.h"     // crisp HUD counter font (#31)
#include "button_tex_png.h"    // crisp HUD button-background disc (#31)
#include "counter_icon_png.h"  // crisp HUD counter icons (#31)
