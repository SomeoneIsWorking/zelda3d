...
## Policy (SoH3D_LinkBoyMidMask): body(45,46) + LH(leftHandType) + RH(rightHandType,currentShield)
##   + back(sheathType,currentShield with HYLIAN/MIRROR). SoH3D_LinkComputeMidMask dispatches
