// SoH3D behavior: En_Fish (ambient swimming fish) — animated model REPLACEMENT. OoT3D renders the
...
// See en_fish.cpp.
#ifndef SOH3D_BEHAVIORS_ACTOR_EN_FISH_H
#define SOH3D_BEHAVIORS_ACTOR_EN_FISH_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_EN_FISH_H
