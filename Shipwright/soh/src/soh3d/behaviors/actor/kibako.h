// SoH3D behavior: Obj_Kibako (small wooden crate) — model REPLACEMENT. OoT3D draws the crate from the
...
#ifndef SOH3D_BEHAVIORS_ACTOR_KIBAKO_H
#define SOH3D_BEHAVIORS_ACTOR_KIBAKO_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_KIBAKO_H
