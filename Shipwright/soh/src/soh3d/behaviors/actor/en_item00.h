// SoH3D behavior: En_Item00 (dropped/placed collectible) — model REPLACEMENT for its RUPEE types.
...
#ifndef SOH3D_BEHAVIORS_ACTOR_EN_ITEM00_H
#define SOH3D_BEHAVIORS_ACTOR_EN_ITEM00_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_EN_ITEM00_H
