// SoH3D behavior: Obj_Hamishi (silver rock — Megaton-Hammer boulder) — model REPLACEMENT. OoT3D
...
#ifndef SOH3D_BEHAVIORS_ACTOR_HAMISHI_H
#define SOH3D_BEHAVIORS_ACTOR_HAMISHI_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_HAMISHI_H
