// SoH3D behavior: En_Door (standard hinged house/dungeon door). Model-REPLACEMENT behavior — OoT3D
...
#ifndef SOH3D_BEHAVIORS_ACTOR_DOOR_H
#define SOH3D_BEHAVIORS_ACTOR_DOOR_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_DOOR_H
