// SoH3D behavior: En_Ex_Ruppy (diving-game / thrown colored rupee) — model REPLACEMENT with a
...
#ifndef SOH3D_BEHAVIORS_ACTOR_RUPPY_H
#define SOH3D_BEHAVIORS_ACTOR_RUPPY_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_RUPPY_H
