// SoH3D behavior: En_Tana (shop shelves) — model REPLACEMENT. OoT3D draws the wooden shop shelf from
...
#ifndef SOH3D_BEHAVIORS_ACTOR_EN_TANA_H
#define SOH3D_BEHAVIORS_ACTOR_EN_TANA_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_EN_TANA_H
