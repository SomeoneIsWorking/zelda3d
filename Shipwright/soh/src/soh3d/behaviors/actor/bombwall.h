// SoH3D behavior: Bg_Bombwall (bombable cracked wall) — model REPLACEMENT. OoT3D draws it from the
...
#ifndef SOH3D_BEHAVIORS_ACTOR_BOMBWALL_H
#define SOH3D_BEHAVIORS_ACTOR_BOMBWALL_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_BOMBWALL_H
