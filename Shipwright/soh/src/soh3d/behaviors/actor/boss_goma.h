// SoH3D behavior: Boss_Goma (Queen Gohma). She renders her OoT3D model (zelda_goma.zar) via the
...
// SoH3D model floats off the pillar (kanban #123). drawSpaceTransform replicates both offsets so the
// model lands exactly where OoT3D draws it on any surface. See boss_goma.cpp.
#ifndef SOH3D_BEHAVIORS_ACTOR_BOSS_GOMA_H
#define SOH3D_BEHAVIORS_ACTOR_BOSS_GOMA_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_BOSS_GOMA_H
