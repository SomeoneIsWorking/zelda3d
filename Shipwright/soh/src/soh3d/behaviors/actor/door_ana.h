// SoH3D behavior: Door_Ana (grotto hole / trapdoor entrance) — model REPLACEMENT. OoT3D draws the
...
#ifndef SOH3D_BEHAVIORS_ACTOR_DOOR_ANA_H
#define SOH3D_BEHAVIORS_ACTOR_DOOR_ANA_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_DOOR_ANA_H
