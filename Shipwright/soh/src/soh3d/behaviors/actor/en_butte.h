// SoH3D behavior: En_Butte (ambient butterfly) — animated model REPLACEMENT. OoT3D renders the
...
#ifndef SOH3D_BEHAVIORS_ACTOR_EN_BUTTE_H
#define SOH3D_BEHAVIORS_ACTOR_EN_BUTTE_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_EN_BUTTE_H
