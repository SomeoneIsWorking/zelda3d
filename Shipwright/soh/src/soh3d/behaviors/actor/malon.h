// SoH3D behaviors: Malon — En_Ma1 (child) and En_Ma2/En_Ma3 (adult). Head/torso track + eye/mouth
// material-anim. See malon.cpp.
#ifndef SOH3D_BEHAVIORS_ACTOR_MALON_H
#define SOH3D_BEHAVIORS_ACTOR_MALON_H
...
#endif // SOH3D_BEHAVIORS_ACTOR_MALON_H
