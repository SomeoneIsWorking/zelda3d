// SoH3D procedural stair geometry (see soh3d_stairs.h). Moved verbatim out of soh3d_model.cpp.
#include "soh3d_stairs.h"
#include "asset/cmb.h"
#include <stb_image.h>
...
bool texNameIsKaidan(const SoH3D::Cmb& cmb, int matIndex) {
...
void generateStairsGroup(SoH3D::CmbDrawGroup& g) {
    size_t ntri = g.verts.size() / 3;
    if (ntri < 2) return;
