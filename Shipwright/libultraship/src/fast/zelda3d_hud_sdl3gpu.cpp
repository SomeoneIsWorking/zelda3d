// Zelda3D PC HUD — SDL3 GPU immediate-mode 2D textured-quad renderer, on the UNIFIED op model.
//
// The Vulkan twin (zelda3d_hud_vk.cpp) recorded its quads into a live command buffer. Here the quads
// are COLLECTED during the Zelda3D_Hud_Begin..End bracket and each coalesced run is appended as a
...
// zelda3d_hud_vk.cpp's extern "C" Zelda3D_Hud_* entry points delegate here when SDL3 GPU is the live one.
